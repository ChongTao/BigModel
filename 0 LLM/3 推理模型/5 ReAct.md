...
如果放到更大的推理范式图谱里，可以把 ReAct 理解为：

- 相比 CoT：ReAct 不只“想”，还会“做”
- 相比单纯 Tool-Use：ReAct 更强调推理与行动交替，而不是只会调用工具
- 相比 Reflexion：ReAct 更强调执行中的闭环，Reflexion 更强调执行后的评估与修正

因此，ReAct 很适合承担“任务推进器”的角色，而 Reflexion 更适合承担“质量改进器”的角色。

在实际系统里，这两者经常组合出现：

- ReAct 负责边推理边行动
- Reflection / Reflexion 负责在关键节点审查结果并修正
