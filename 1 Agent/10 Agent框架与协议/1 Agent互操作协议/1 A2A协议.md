...
A2A 是与 Anthropic 模型上下文协议 (Model Context Protocol, MCP) 互补的协议。MCP 侧重于为智能体及其与外部数据和工具的交互构建上下文, 而 A2A 则促进智能体之间的协调与通信, 从而实现任务委派和协作。更多信息见 [3 MCP协议.md](./3%20MCP%E5%8D%8F%E8%AE%AE.md)。
...
详细信息见[a2aproject](../2%20具体框架实现/1%20a2aproject/1%20a2aproject.md)
...
更多信息见[tRPC-agent-Go](../2%20具体框架实现/2%20tRPC-Agent-Go/1%20tRPC-Agent-Go介绍.md)
