...
A2A 是与 Anthropic 模型上下文协议 (Model Context Protocol, MCP) 互补的协议。MCP 侧重于为智能体及其与外部数据和工具的交互构建上下文, 而 A2A 则促进智能体之间的协调与通信, 从而实现任务委派和协作。（[图片来源](https://github.com/ginobefun/agentic-design-patterns-cn/blob/main/images/chapter15_fig1.png)）

![Comparison A2A and MCP Protocols](./assets/chapter15_fig1.png)
