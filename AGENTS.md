...
- `0 LLM`, `1 Agent`, `2 RAG`, `3 NLP`, `4 Harness`, `5 开源生态`, `6 生产`
- `9 论文&博客`, `99 工具`
...
- `rg --files` to list documentation files quickly.
...
- Preserve the existing language context; many files use Chinese, and English is acceptable when appropriate.
